      ...
      final credential = await FirebaseAuth.instance.createUserWithEmailAndPassword(
        ...
        if(file!=null){
          ...
          await storageRef
            ...
            addTeacher(name!, phone, email, exp!, specialize!, intro!);
          });
...
// Listen for state changes, errors, and completion of the upload.
  ...
  Future<bool> addTeacher(String name, String phone, String email, String exp, String specialize, String intro) async{
    String url = '';
    try {
  ...
  Future<bool> updateTeacher(File? imageFile,String name, String phone, String exp, String specialize, String intro, String keyUser, String linkImage) async{
