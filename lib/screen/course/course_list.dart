        ...
        children: [
          Container(
            ...
            Stack(
              fit: StackFit.expand,
              children: [
                Center(child: NeoText(CommonKey.HOME_PAGE==widget._keyFlow?'Khóa học':'', textStyle: TextStyle(color: AppColors.lightBlue, fontSize: 16, fontWeight: FontWeight.bold), textAlign: TextAlign.center)),
